...
var postCodeBtn = document.getElementById('searchPostCodeBtn')
var foldBtn = document.getElementById('btnFoldWrap')

postCodeBtn.addEventListener('click', execDaumPostCode)
foldBtn.addEventListener('click', foldDaumPostCode)
